...
export const copyRouterMap = asyncRouterMap;
        ...
        children: [
            ...
            },
            {
                ...
                children: [{
                    ...
                    {path: 'iconfont', name: 'Icon图标', icon: 'ios-keypad', component: _import('components/Iconfont')},
            ...
            {path: 'shopchart', name: '系统数据状态', icon: 'stats-bars', component: _import('SystemDataStatus')},
            {path: '/table', name: 'ETL管理-任务管理', icon: 'ios-paper', component: _import('Table'), meta: {role: ['admin']}},
            {path: '/tabledetail', name: '任务详情', hidden:'true' , icon: 'ios-paper', component: _import('TableDetail'), meta: {role: ['admin']}},
...
export const nullRouterMap = asyncRouterMap
