...
<script>
    ...
    export default {
        ...
        created() {
            console.log("created function asyncRouterMap ====  === == ");
            console.log(asyncRouterMap);
            // console.log(JSON.stringify(asyncRouterMap));

            var storageStr = JSON.stringify(asyncRouterMap);
            localStorage.setItem("asyncRouterMap", storageStr);//存储localStorage
            var user=JSON.parse(localStorage.getItem("asyncRouterMap"));//获取localStorage
            console.log("Cookies get ==================================");
            // const avc =  Cookies.get("asyncRouterMap");//.parseJSON()
            console.log(user);
        },
    }
