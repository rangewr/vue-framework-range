        ...
        <Row :gutter="20">
            ...
            <Col :span="12">
                ...
                <!--<div>-->
                    <!--<table >-->
                        <!--<tr>-->
                            <!--<td width="30%" style="background-color: deeppink"></td>-->
                            <!--<td> <div  style="border:50px solid transparent; border-left:50px solid deeppink; border-top:50px solid deeppink; border-bottom: 50px solid deepskyblue; border-right: 50px solid deepskyblue"></div>-->
                            <!--</td>-->
                            <!--<td width="70%" style="background-color: deepskyblue"></td>-->
                        <!--</tr>-->
                    <!--</table>-->
                <!--</div>-->
            </Col>
